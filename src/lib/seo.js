...
export function applyFranchiseSeo() {
  ...
  setMeta('name', 'keywords', [
    'франшиза спа салона', 'франшиза buddha spa', 'тайский массаж франшиза казахстан',
    'spa франшиза казахстан', 'открыть спа салон', 'инвестиции спа казахстан',
    'франшиза массажного салона', 'франшиза алматы', 'франшиза астана', 'франшиза шымкент',
    ...
    'spa бизнес казахстан', 'wellness франшиза казахстан', 'тайский массаж бизнес',
    'готовый бизнес спа', 'буддha спа франшиза', 'buddha spa franchise kazakhstan',
  ].join(', '))
  ...
  setJsonLd('ld-franchise', {
    ...
    mainEntity: {
      ...
      offers: {
        ...
        description: 'Стартовые инвестиции от 80 млн ₸. Формат «Партнёр» — без роялти, 50/50. Формат «Франшиза» — роялти 7%, паушальный взнос 5 млн ₸.',
      },
    },
    breadcrumb: {
      '@type': 'BreadcrumbList',

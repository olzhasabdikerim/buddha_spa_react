...
export const MAIN_TR = {
  ...
  kk: {
    ...
    'Услуги': 'Қызметтер', 'SPA-программы': 'SPA-бағдарламалар', 'Массаж всего тела': 'Дене массажы',
    'Массаж по зонам': 'Аймақтық массаж', 'Уход за телом': 'Дене күтімі',
    'Шымкент': 'Шымкент', 'Тараз': 'Тараз', 'Астана': 'Астана', 'Актобе': 'Ақтөбе',
    'Нурсат': 'Нұрсат', 'Тулпар': 'Тұлпар', 'Иляева': 'Іляева', 'Таукехан': 'Тәуке хан',
    'Толе би': 'Төле би', 'Туран': 'Тұран', 'Тауелсыздык': 'Тәуелсіздік',
    // hero
    ...
    'Сеть SPA-салонов, где тайская атмосфера и мастерство превращают массаж в полноценный отдых и восстановление.':
      'Тай атмосферасы мен шеберлік массажды толыққанды демалыс пен қалпына келтіруге айналдыратын SPA-салондар желісі.',
    'Связаться с нами': 'Бізбен байланысу',
    'Перейти': 'Өту', 'Скоро': 'Жақында', 'Скоро откроется': 'Жақында ашылады',
    'Открытие совсем скоро': 'Ашылуы жақын арада', 'Смотреть филиалы': 'Филиалдарды көру',
    'Филиал': 'Филиал', 'Выберите филиал': 'Филиалды таңдаңыз',
    'Пожалуйста, выберите филиал': 'Өтінеміз, филиалды таңдаңыз', 'Длительность': 'Ұзақтығы',
    ...
    'Оформить сертификат в WhatsApp': 'WhatsApp арқылы сертификат рәсімдеу',
  ...
  en: {
    ...
    'Услуги': 'Services', 'SPA-программы': 'SPA programs', 'Массаж всего тела': 'Full-body massage',
    'Массаж по зонам': 'Targeted massage', 'Уход за телом': 'Body care',
    'Шымкент': 'Shymkent', 'Тараз': 'Taraz', 'Астана': 'Astana', 'Актобе': 'Aktobe',
    'Нурсат': 'Nursat', 'Тулпар': 'Tulpar', 'Иляева': 'Ilyaeva', 'Таукехан': 'Tauke Khan',
    'Толе би': 'Tole bi', 'Туран': 'Turan', 'Тауелсыздык': 'Tauelsizdik',
    ...
    'Сеть SPA-салонов, где тайская атмосфера и мастерство превращают массаж в полноценный отдых и восстановление.':
      'A network of SPA salons where Thai atmosphere and craft turn massage into true rest and recovery.',
    'Связаться с нами': 'Contact us',
    'Перейти': 'View', 'Скоро': 'Soon', 'Скоро откроется': 'Opening soon',
    'Открытие совсем скоро': 'Opening very soon', 'Смотреть филиалы': 'View locations',
    'Филиал': 'Location', 'Выберите филиал': 'Choose a location',
    'Пожалуйста, выберите филиал': 'Please choose a location', 'Длительность': 'Duration',
    ...
    'Оформить сертификат в WhatsApp': 'Get a certificate on WhatsApp',
    'Собрали ответы на самые популярные вопросы. Не нашли нужный — напишите нам, и мы поможем.':
